...
import 'package:eshop_multivendor/Screen/NewProductDetails.dart';
...
import '../Model/OfferImagesModel.dart';
...
class _HomePageState extends State<HomePage>
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    //   child: Text("Best Deals", style:TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.w600)),
                    // ),
                    // getImages(),
                    SizedBox(height: 10),
                    Padding(
                      padding: const EdgeInsets.only(left: 20),
                      child: Text("Shop By Category", style:TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.w600)),
                    ),
                    _catList(),
                    // Padding(
                    ...
                    //       InkWell(
                    //         onTap: () {
                    //           Navigator.push(context, MaterialPageRoute(builder: (context) => AllCategory(isAppBar: true,)));
                    //         },
                    //         child: catList.length>= 9 ? Center(child: Text("View all categories",style: TextStyle(color: colors.primary),)):SizedBox.shrink(),
                    //       ),
                    //     ],
                    //   ),
                    // ),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 20),
                      child: Text("Offers for you", style:TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.w600)),
                    ),
                    SizedBox(height: 10),
                    _slider(),
                    // _section(),
      ...
      (_) {
        if (mounted) {
          ...
          if (_controller.hasClients)
            _controller.animateToPage(nextPage, duration: Duration(milliseconds: 200), curve: Curves.linear).then((_) => _animateSlider());
        }
      },
    );
  }
  ...
  getImages() {
    ...
    return Padding(
      ...
      child: Container(
        height: 230,
          child: offerImagesModel == null || offerImagesModel  == "" ? Center(child: CircularProgressIndicator()):
        GridView.builder(
            gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                ...
                crossAxisSpacing: 20,
                mainAxisSpacing: 20),
            itemCount: offerImagesModel!.data![0].offerData!.length,
          shrinkWrap: true,
          physics: NeverScrollableScrollPhysics(),
          itemBuilder: (context, index) {
            // if (index == 0)
            //   return Container();
            // else
              print("imagessssrrrs ${offerImagesModel!.data![0].offerData![index].image}");
              return Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: InkWell(
                              // onTap: () {
                              //   Navigator.push(context, MaterialPageRoute(builder: (context) => NewProductDetails(
                              ...
                              child: ClipRRect(
                                ...
                                child: new FadeInImage(
                                  fadeInDuration: Duration(milliseconds: 150),
                                  image: CachedNetworkImageProvider(
                                     "${offerImagesModel!.data![0].offerData![index].image}"
                                  ),
                                  height: 90.0,
                                  width: double.infinity,
                                  fit: BoxFit.fill,
                          ...
                          Container(
                            child: Text(
                              "${offerImagesModel!.data![0].offerData![index].name}",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyText1!
                                  .copyWith(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 7,),
                                  Text(
                                    "₹ ${offerImagesModel!.data![0].offerData![index].variants![index].price}",
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText1!
                                        .copyWith(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              height: 30,
                              width: 100,
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: colors.primary),
                              child: Padding(
  ...
  getOfferImage() async{
    var headers = {
      'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2Nzg5NzMxNzQsImlzcyI6ImVzaG9wIiwiZXhwIjoxNjc4OTc0OTc0fQ.b1pz0rxq0ivbalYOYCOZ30IOORYzJDcMQkLcyi5l_q8',
      'Cookie': 'ci_session=0cb1133afc41fead394c7cf2f773277f55f04b0c'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://everydayonline.co.in/app/v1/api/get_offer_images'));
    request.fields.addAll({
      USER_ID: CUR_USERID.toString(),
    });
    print("userrrrrr id ${CUR_USERID.toString()}");
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      var finalResponse = await response.stream.bytesToString();
      var imageOffer = OfferImagesModel.fromJson(jsonDecode(finalResponse));
      setState(() {
         offerImagesModel = imageOffer;
      });
      print("final Responseeee ${finalResponse.toString()}");
      print("Offer Image Model ${offerImagesModel.toString()}");
    }
    else {
  ...
  _OfferImages() async{
    var headers = {
      'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2Nzg5NzMxNzQsImlzcyI6ImVzaG9wIiwiZXhwIjoxNjc4OTc0OTc0fQ.b1pz0rxq0ivbalYOYCOZ30IOORYzJDcMQkLcyi5l_q8',
      'Cookie': 'ci_session=fa66df192fa14c1062a604a66dc9d25ac2773361'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://everydayonline.co.in/app/v1/api/get_offer_images'));
    request.fields.addAll({
      USER_ID: CUR_USERID.toString(),
  ...
  void getCat() {
    ...
    apiBaseHelper.postAPICall(getCatApi, parameter).then((getdata) {
      ...
      print("Categories ${parameter.toString()}");
      bool error = getdata["error"];
      String? msg = getdata["message"];
      if (!error) {
        var data = getdata["data"];
