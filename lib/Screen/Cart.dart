...
import '../Model/ExpressdeliveryModel.dart';
import '../Model/Model.dart';
import '../Model/NormalChargeModel.dart';
...
double totalPrice = 0, oriPrice = 0, delCharge = 0, taxPer = 0, finalCharge = 0;
...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  expressCharge() async {
    var headers = {
      'Cookie': 'ci_session=1e5bab350517d2fccd14b8c0581363a24f67f0af'
    };
    var request = http.MultipartRequest(
        'GET',
        Uri.parse(
            'https://everydayonline.co.in/app/v1/api/get_express_delivery_fee'));
    ...
    if (response.statusCode == 200) {
      ...
      var getExpress = ExpressdeliveryModel.fromJson(jsonDecode(finalResponse));
      print("Profile Here>>>>>>${jsonResponse}");
      setState(() {
        expressdeliveryModel = getExpress;
      });
      print("yes data is here ${expressdeliveryModel!.charge.toString()} ");
      for (var i = 0; i < expressdeliveryModel!.charge!.length; i++) {
        exCharge = expressdeliveryModel!.charge![i].fee;
      }
      setState(() {});
      print("ori price____________ ${exCharge} and ${oriPrice}");
      print("finalTotal____________ ${finalTotal}");

      finalTotal = oriPrice + double.parse(exCharge.toString()) - promoAmt;
      print("express charge here now ${finalTotal}");
    } else {
      print(response.reasonPhrase);
    }
  }

  NormalChargeModel? getNormal;
  // var finalCharge;
  var normalTotal;
  var normalDel;
  ...
  normalCharge() async {
    ...
    var request = http.MultipartRequest('GET',
        Uri.parse('https://everydayonline.co.in/app/v1/api/get_delivery_fee'));

    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    print("responseeeeeeeeeee ${response.statusCode}");
    if (response.statusCode == 200) {
      print("sfsfsfs");
      var finalResponse = await response.stream.bytesToString();
      //  final jsonResponse = json.decode(finalResponse);
      var getNormal = NormalChargeModel.fromJson(jsonDecode(finalResponse));
      print("final Responseeee ${finalResponse.toString()}");
      // print("Get Normal ${getNormal.charge![i].deliveryCharge.toString()}");
      print("Normal>>>>>>${NormalChargeModel}");
      for (var i = 0; i < getNormal.charge!.length; i++) {
        print("okm ${getNormal.charge![i].minKm}");
        if (oriPrice > double.parse(getNormal.charge![i].minKm.toString()) &&
            oriPrice < double.parse(getNormal.charge![i].maxKm.toString())) {
          setState(() {});
          normalDel =
              double.parse(getNormal.charge![i].deliveryCharge.toString());
          normalTotal = oriPrice + normalDel - promoAmt;
          print("checking final charge ${normalTotal}");
        } else {
          setState(() {});
          normalDel = 0;
          normalTotal = oriPrice + normalDel - promoAmt;
          print("checking final charge else ${normalTotal}");
        }
      }
      // var getNormal = NormalChargeModel.fromJson(jsonDecode(finalResponse));
      // setState(() {
                                ...
                                SimBtn(
                                  ...
                                  onBtnSelected: () {
                                    ...
                                    if (_value1 == 'Normal') {
                                      ...
                                      print('_____fgggg_____${isFrom}_________');
                                    }
  ...
  Future<void> addToCart(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("Manage Cart api ${parameter.toString()}");
        Response response =
        ...
        try {
          ...
          if (response.statusCode == 200) {
            ...
            if (!error) {
              ...
              totalPrice = delCharge + oriPrice;
              print('${delCharge}_________delCharge');
  ...
  _showContent(BuildContext context) {
    ...
    // print("normal charge ${normalChargeModel?.charge?.length-1}");
    return _isCartLoad
        ? shimmer(context)
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: <
                      ...
                      Column(
                        ...
                        children: [
                                    ...
                                    Radio(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          ...
                                          isDelivery = true;
                                          print(
                                              "promocode normal ${isPromoValid!}");
                                          isPromoValid! == _value1
                                              ? finalTotal - promoAmt
                                              : normalCharge();
                                             setState(() {
                                             isFrom = true;
                                    ...
                                    Radio(
                                        ...
                                        onChanged: (value) {
                                          setState(() {
                                            ...
                                            // if(promoAmt != 0) {
                                            //   setState(() {
                                            //     finalTotal = finalTotal - promoAmt;
                                            //   });
                                            // }
                                          });
                                        }),
                          ...
                          _value1 == null || _value1 == "null" || _value1 == ""
                              ? SizedBox.shrink()
                              : Column(
                                  children: [
                                    Padding(
                                  ...
                                  oriPrice == null ||
                                      ...
                                      : Text(
                                          _value1 == null ||
                                              ...
                                              ? "${oriPrice.toStringAsFixed(2)}"
                                              : _value1 == 'Normal'
                                                  ? "${normalTotal == null ? "0.0" : normalTotal}"
                                                  : "${finalTotal == null ? "0.0" : finalTotal}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .subtitle1!
                                              .copyWith(
                      ...
                      double.parse(MIN_ALLOW_CART_AMT!) > oriPrice
                          ? Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    "Your minimum order amount is lower(100)\n       increase your order quantity",
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.bold,
                                        color: colors.primary),
                          ...
                          :
                          //     if (double.parse(MIN_ALLOW_CART_AMT!) > oriPrice)
                          // {setSnackbar(getTranslated(context, 'MIN_CART_AMT')!,
                          //     _checkscaffoldKey)}
                          SimBtn(
                              size: 0.9,
                              ...
                              onBtnSelected: () async {
                                // checkoutStatus();
                                if (_value1 == null || _value1 == "") {
                                  setSnackbar(
                                      getTranslated(context,
                                          'Please Select deliver type')!,
                                      _scaffoldKey);
                                } else {
                                  // checkoutStatus();
                                  if (oriPrice > 0) {
                                          ...
                                          child: SimBtn(
                                              ...
                                              onBtnSelected: _placeOrder
                                                  ? () {
                                                      ...
                                                      if (selAddress == null ||
                                                        ...
                                                        if (_value1 ==
                                                          ...
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                  builder: (BuildContext context) => Payment(updateCheckout, msg, finalTotal,isFrom)));
                                                        }
                                                      }
                                                      else if (isTimeSlot! && int.parse(allowDay!) > 0 &&
                                                          (selDate == null || selDate!.isEmpty)) {
                                                        print("dddddddddddd ${selDate}");
                                                        msg = getTranslated(context, 'dateWarning');
                                                        if (_value1 == "Normal") {
                                                          print("Slecet express and Delivery type for tab ${_value1}");
                                                          Navigator.push(context, MaterialPageRoute(
                                                                  builder: (BuildContext context) => Payment(updateCheckout, msg, normalTotal,isFrom)));
                                                          checkoutState!(() {_placeOrder = true;
                                                          });
                                                        } else {
                                                          checkoutState!(() {_placeOrder = true;
                                                          });
                                                        ...
                                                        checkoutState!(() {
                                                          ...
                                                          (selTime == null || selTime!.isEmpty)) {msg = getTranslated(context, 'timeWarning');
                                                        if (_value1 == "Normal") {
                                                          Navigator.push(context,
                                                              MaterialPageRoute(builder: (BuildContext context) => Payment(updateCheckout, msg, normalTotal,isFrom)));
                                                          checkoutState!(() {
                                                            _placeOrder = true;
                                                          });
                                                        } else {
                                                      ...
                                                      // else if (double.parse(MIN_ALLOW_CART_AMT!) > oriPrice) {setSnackbar(getTranslated(context, 'MIN_CART_AMT')!, _checkscaffoldKey);}
                                                      else if (!deliverable) {
                                                        checkDeliverable();
                                                      } else
                                                        // doPayment();
  ...
  doPayment() {
    print('_____SuredraRaj_____${totalPrice}_________');
  ...
  checkoutStatus() async {
    print("Check out statusss apii");
    var headers = {
      'Cookie': 'ci_session=c070c36e97948b1e85e4de75ddc68f41cb8aca71'
    };
    var request = http.MultipartRequest('POST',
        Uri.parse('https://everydayonline.co.in/app/v1/api/web_status'));
    ...
    if (response.statusCode == 200) {
      var finalResponse = await response.stream.bytesToString();
      final jsonResponse = json.decode(finalResponse);
      print("Checout sttauts ${finalResponse}");
      if (jsonResponse['status'] == "0") {
        var onlineStatus = finalResponse;
        print("onlineeeeeeee responseeeeeee ${onlineStatus}");
        ...
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            if (addressList.length == 1) {
              ...
              if (!ISFLAT_DEL) {
                // if (addressList[0].freeAmt != null ||
                //     addressList[0].freeAmt !=
                //         "") if (totalPrice <
              ...
              for (int i = 0; i < addressList.length; i++) {
                if (addressList[i].isDefault == "1") {
                  ...
                  if (!ISFLAT_DEL) {
                    // if ( addressList[i].freeAmt != null || addressList[i].freeAmt != "" )
  ...
  void _handlePaymentError(PaymentFailureResponse response) {
    ...
    Fluttertoast.showToast(msg: "Cancel by User");
 ...
 int? amount;
  ...
  razorpayPayment() async {
    print('____Amond______${totalPrice.toString()}_________');
    SettingProvider settingsProvider =
        Provider.of<SettingProvider>(this.context, listen: false);
    String? contact = settingsProvider.mobile;
    String? email = settingsProvider.email;
    if(_value1 == "Normal") {
    amount = int.parse(totalPrice.toStringAsFixed(0)) * 100;
    }
    else{
      amount = int.parse(finalTotal.toStringAsFixed(0)) *100;
    }
    if (contact != '' && email != '') {
      print('____ExpressTotal______${finalTotal}_________');
      print("-----NormalTotalll---${normalTotal}---------");
      context.read<CartProvider>().setProgress(true);
      checkoutState!(() {});
      var options = {
        KEY: razorpayId,
        AMOUNT: amount,
        NAME: "EveryDay Online",
    ...
    if (_isNetworkAvail) {
      ...
      try {
        var parameter = {
          ...
          FINAL_TOTAL:
              _value1 == null ? oriPrice.toString() : finalTotal.toString(),
          // totalPrice.toString(),
          DEL_CHARGE:
              _value1 == 'Normal' ? normalDel.toString() : exCharge.toString(),
          "delivery_type": _value1,
          // delCharge.toString(),
        ...
        print("parameter productsss ${parameter.toString()}");
        if (isTimeSlot!) {
        ...
        onTap: () async {
          ...
          if (_value1 == "Normal") {
            await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) =>
                            Payment(updateCheckout, msg, normalTotal,isFrom)))
                .then((value) {
              walletBalance = value;
            });
            checkoutState!(() {
            ...
            await Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) =>
                            Payment(updateCheckout, msg, finalTotal, isFrom)))
                .then((value) {
              walletBalance = value;
            });
          }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  oriPrice == null || oriPrice == "" || oriPrice == "null"
                      ? Text("0.0")
                      : Text(
                          _value1 == null || _value1 == "null" || _value1 == ""
                              ? "${oriPrice.toStringAsFixed(2)}"
  ...
  Future<void> validatePromo(bool check) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("promo code para ${parameter.toString()}");
        Response response =
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  // oriPrice == null || oriPrice == "" || oriPrice == "null" ? Text("0.0") :   Text(
                                  //   _value1 == null || _value1 == "null" || _value1 == "" ?  "${oriPrice.toStringAsFixed(2)}" :   _value1 == 'Normal' ?  "${normalTotal  == null ? "0.0" : normalTotal}":
                                  //   "${finalTotal == null  ? "0.0" : finalTotal }",
                                  //   style: Theme.of(context)
                                  //       .textTheme
                                  //       .subtitle1!
                              ...
                              isPromoValid!
                                  ...
                                  ? Row(
                                      ...
                                      children: [
                                        ...
                                        // Text(
                                        //   CUR_CURRENCY! +
                                        //       '${double.parse((walletBalance ?? '0')) + double.parse(usedBal.toStringAsFixed(2))}',
                                        //   style: Theme.of(context)
                                        //       .textTheme
                                        //       .subtitle2!
                                        //       .copyWith(
