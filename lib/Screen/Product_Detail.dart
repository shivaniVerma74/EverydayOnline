...
/*  _transactionscrollListener() {
  ...
  Widget _slider() {
    double height = MediaQuery.of(context).size.height * .44;
    double statusBarHeight = MediaQuery.of(context).padding.top;
  //top products image here
    return InkWell(
      onTap: () {
        // Navigator.push(
        //     context,
                  ...
                  return Stack(
                    children: [
                      FadeInImage(
                        ...
                        fit: extendImg ? BoxFit.contain : BoxFit.fitWidth,
    ...
    if (_isNetworkAvail) {
      try {
        if (notificationisloadmore) {
          ...
          var getdata = json.decode(response.body);
          print('products parameter ${getProductApi.toString()}');
          print('products parameter ${parameter.toString()}');
          bool error = getdata["error"];
          print('products parameter ${parameter.toString()}');
          // String msg = getdata["message"];
