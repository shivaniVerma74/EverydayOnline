...
class Payment extends StatefulWidget {
  ...
  Payment(this.update, this.msg, this.finalPrice,this.isFrom);
...
String? walletBalance ;
  ...
  Widget build(BuildContext context) {
    print('_____kya aya hai_____${widget.isFrom}_________');
    print("remaininggggg balance&&&&&&&& ${remWalBal.toStringAsFixed(2)}");
    return Scaffold(
      key: _scaffoldKey,
                    ...
                    children: [
                      Expanded(
                        child: SingleChildScrollView(
                            ...
                            children: [
                              Consumer<UserProvider>(
                                  builder: (context, userProvider, _) {
                                    walletBalance = userProvider.curBalance ;
                                return Card(
                                  elevation: 0,
                                                  ...
                                                  if (value!) {
                                                    if (totalPrice <=
                                                        double.parse(
                                                            userProvider
                                                                .curBalance)) {
                                                      print('${totalPrice}____________________');
                                                      // remWalBal = (double.parse(userProvider.curBalance) if() {
                                                      //   _value1 == 'Normal' - normalDel ? _value1 == 'Express' - exCharge
                                                      // });
                                                      // var _value1;
                                                      // if(_value1 == 'Normal') {
                                                      //
                                                      // }
                                                      remWalBal = (double.parse(userProvider.curBalance) - widget.finalPrice);
                                                      usedBal = totalPrice;
                                                      payMethod = "Wallet";
                                                      isPayLayShow = false;
                                                    } else {
                                              ...
                                              child: Text(
                                                isUseWallet!
                                                    ...
                                                    : getTranslated(context,
                                                        ...
                                                        CUR_CURRENCY! +
                                                        " " +
                                                        double.parse(userProvider.curBalance).toStringAsFixed(2),
                                                style: TextStyle(
                                                    fontSize: 15,
                          ...
                          widget.isFrom == false ? Container() : isTimeSlot!
                                  ?  Card(
                                      elevation: 0,
                                      child: Column(
                                        crossAxisAlignment:
                      ...
                      SimBtn(
                        ...
                        onBtnSelected: () {
                          Navigator.pop(context, walletBalance);
                        },
                      ),
                    ],
                  ),
            ...
            for (int i = 0; i < timeSlotList.length; i++) {
              ...
              if (cur.isBefore(last)) {
                timeModel.add(new RadioModel(
                    ...
                    img: '',
                    time: timeSlotList[i].fromTime,
                  // time1: timeSlotList[i].lastTime,
                ));
              }
            }
          }
  ...
  Future<void> _getdateTime() async {
    ...
    if (_isNetworkAvail) {
      ...
      try {
       ...
       print("Get Settingsss parameter ${parameter}");
